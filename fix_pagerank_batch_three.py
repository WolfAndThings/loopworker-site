...
PAGES = {
    ...
    "how-to-price-creative-services.html": {
        "subtitle": "Evidence-led services should be priced from value, delivery scope, and margin targets rather than vague confidence or what the client seems willing to pay. This guide covers tiering, anchors, objections, and pricing AI-enhanced work.",
        ...
        "replacements": [
            ...
            ("Value-Based Pricing Explained", "What is value-based pricing for evidence-led services?"),
            ...
            ('Handling \\"That Is Too Expensive\\"', 'How should you handle "that is too expensive" objections?'),
            ("Pricing AI-Enhanced Services", "How should you price AI-enhanced evidence-led services?"),
            ("Real Pricing by Service Type", "What pricing ranges make sense by service type?"),
            ("The Bottom Line", "What is the bottom line on pricing evidence-led services?"),
        ],
    },
